...
class BotEnsemble:
    ...
    #     self.device = device
    #
    #     # Detect if it's a Torch model (vs sklearn)
    #     self.is_torch_model = isinstance(numeric_model, torch.nn.Module)
    #     if self.is_torch_model:
    #         self.numeric_model = numeric_model.eval().to(device)
    ...
    #     elif isinstance(self.numeric_model, BaseEstimator):
    ...
    #     else:
    #         raise TypeError("Unsupported numeric model type. Must be PyTorch or sklearn.")
    #
